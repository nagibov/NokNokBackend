...
public class ProductItemDto
{
    ...
    public ProductCharacteristicsDto DefaultProductCharacteristics { get; set; } = new();
    ...
    public string? IdThirdParty { get; set; }
    public string? TenantId { get; set; }
    public string? OperationId { get; set; }
    public string? TenantUid { get; set; }
    public string? OperationUid { get; set; }
    public string? ProductRefId { get; set; }
    public List<ProductCustomizationItemDto> ProductCustomization { get; set; } = [];
    public List<ProductVariationItemDto> ProductVariation { get; set; } = [];
    public UiCustomizationDto? UiCustomization { get; set; }
}
...
public class ProductVariationItemDto
{
    public required string Title { get; set; }
    public required List<string> Options { get; set; }
    public bool IsMultiSelect { get; set; }
